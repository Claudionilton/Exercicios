...
public class Main {
    public static void main(String[] args) {
        ...
        while (desejaRepetir == 's' || desejaRepetir == 'S') {
            ...
            System.out.println("Digite o ano de fabricação do veitulo");
            anoFabricacao = leitor.nextInt();
            System.out.println("Digite valor do veitulo");
        ...
        System.out.println("Total de carros velhos:" + totalCarrosVelhos);
